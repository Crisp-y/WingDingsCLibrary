...
Font.h just contains the library.
The DemoCode folder contains edited code from task 2 to show each new character and "HELLO WORLD!".
It can easily be edited to show more phrases using the display_string() function.
